...
frame<-w_rate %>% 
  filter((avg*12>11000|(avg*12>9500&SFMF=="MF"))&avg*12<=34000)

frame$e_heat[frame$e_heat=="Gas Heat"]<-"Non-Elec Heat"
frame$avg.annual<-frame$avg*12

frame$usage_level<-"NOT DEFINED"
frame$usage_level[frame$avg.annual>=9500&frame$avg.annual<11000]<-"UT11"
frame$usage_level[frame$avg.annual>=11000&frame$avg.annual<12500]<-"UT12.5"
frame$usage_level[frame$avg.annual>=12500&frame$avg.annual<14000]<-"UT14"
frame$usage_level[frame$avg.annual>=14000&frame$avg.annual<=34000]<-"UT34"
